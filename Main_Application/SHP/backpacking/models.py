...
class Buser(models.Model):
    ...
    def __str__(self):
        return "%s - %s" % (self.userid, self.nickname)
...
class Blogphoto(models.Model):
    ...
    postid = models.ForeignKey(
        'Blogpost', models.DO_NOTHING, db_column='postid')
...
=======
    ...
    author = models.ForeignKey(
        Buser, models.DO_NOTHING, db_column='author', blank=True, null=True)
...
class Blogtag(models.Model):
    postid = models.ForeignKey(
        Blogpost, models.DO_NOTHING, db_column='postid', primary_key=True)
...
class Comment(models.Model):
    ...
    postid = models.ForeignKey(
        Blogpost, models.DO_NOTHING, db_column='postid', blank=True, null=True)
    ...
    def __str__(self):
        return "%s - %s" % (self.commentid, self.postid)
...
class Likepost(models.Model):
    userid = models.ForeignKey(
        Buser, models.DO_NOTHING, db_column='userid', primary_key=True)
...
class Travelinfo(models.Model):
    ...
    budgetmax = models.IntegerField(
        db_column='budgetMax', blank=True, null=True)
    # Field name made lowercase.
    budgetmin = models.IntegerField(
        db_column='budgetMin', blank=True, null=True)
    destination = models.CharField(max_length=100, blank=True, null=True)
    # Field name made lowercase.
    starttime = models.DateField(db_column='startTime', blank=True, null=True)
    # Field name made lowercase.
    endtime = models.DateField(db_column='endTime', blank=True, null=True)
    userid = models.ForeignKey(
        Buser, models.DO_NOTHING, db_column='userid', blank=True, null=True)

    def __str__(self):
        return "%s - %s" % (self.travelinfo_id, self.userid)
